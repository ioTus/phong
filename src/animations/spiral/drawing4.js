/**
 * Drawing4 — Growing spiral of duplicated shapes.
 */
import { MovieClip } from '../../lib/phong-runtime.js';

export async function setup(stage) {
  const shapeImg = await stage.loadSVG('/extracted/spiral/drawing4/shapes/1.svg');
  ...
  container.onFrame = function(self) {
    ...
    if (clone) {
      ...
      clone._y = self.i / 2 + Math.cos(clone._rotation / 360 * Math.PI * 8) * 10;
      const s = self.i / 2;
      clone._xscale = s;
      clone._yscale = s;
    }
